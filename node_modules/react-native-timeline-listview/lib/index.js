...
export default class Timeline extends Component {
  ...
  _isSend(text){
    ...
    console.log(this.searchText + ' ' + this.state.result)
  }
  _Send(){
  ...
  _renderDetail(rowData, sectionID, rowID) {
    let title = rowData.description ? (
      <View>
        ...
        <Demande etat={this.state.result} />
      </View>
    ) : (
      <View>
        <Text style={[styles.title, this.props.titleStyle]}>{rowData.title}</Text>
        <TextInput onChangeText={(text) => this._isSend(text)} style={{ width: 200, marginLeft: 5, borderBottomWidth: 1, borderBottomColor: '#555', marginBottom: 10 }} placeholder="Code de la demande"/>
        <Button success style={{paddingLeft: 20, width: 100, marginTop: 10}} onPress={(text) => this._Send()}><Text style={{color:"white", fontSize: 15}}>Suivant</Text></Button>
      </View>
